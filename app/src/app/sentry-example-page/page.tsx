    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://cooking-with-code.sentry.io/issues/?project=4509357885227008">Issues Page</a>.
